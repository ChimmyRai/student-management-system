<div class="card">
    <div class="card-header">Result Upload (Class 11 and 12 Science)</div>
    <div class="card-body">
         ...
         <div class="form-row mt-sm-3">
               ...
               <table class="table table-bordered">
                            ...
                            <!--  <th class="nonToogleDisplay header">
                             ...
                             <th class="header">
                                 <a wire:click.prevent="sortBy('physics')" role="button" href="#">Phy
                                   @include('includes._sort-icon',['field'=>'physics'])</a>
                             </th>

                               <th class="header">
                                   <a wire:click.prevent="sortBy('chemistry')" role="button" href="#">Chem
                                     @include('includes._sort-icon',['field'=>'chemistry'])</a>
                               </th>
                               <th class="header">
                                   <a wire:click.prevent="sortBy('biology')" role="button" href="#">Bio
                                     @include('includes._sort-icon',['field'=>'biology'])</a>
                               </th>
                               <th class="header">
