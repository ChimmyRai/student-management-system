<div class="card">
    <div class="card-header">Result Upload (Class 11 and 12 Arts)</div>
    <div class="card-body">
             ...
             Download table:<br/>
               ...
               <table class="table table-bordered">
                            ...
                            <!--  <th class="nonToogleDisplay header">
                             ...
                             <th class="header">
                                 <a wire:click.prevent="sortBy('b_math')" role="button" href="#">B_Math
                                   @include('includes._sort-icon',['field'=>'b_math'])</a>
                             </th>

                             <th class="header">
                                 <a wire:click.prevent="sortBy('geography')" role="button" href="#">Geo
                                   @include('includes._sort-icon',['field'=>'geography'])</a>
                             </th>

                               <th class="header">
                                   <a wire:click.prevent="sortBy('history')" role="button" href="#">His
                                     @include('includes._sort-icon',['field'=>'history'])</a>
                               </th>
                               <th class="header">
                                   <a wire:click.prevent="sortBy('economics')" role="button" href="#">Eco
                                     @include('includes._sort-icon',['field'=>'economics'])</a>
                               </th>
                               <th class="header">
                                   <a wire:click.prevent="sortBy('media_studies')" role="button" href="#">Media
                                     @include('includes._sort-icon',['field'=>'media_studies'])</a>
                               </th>
                               <th class="header">
                                   <a wire:click.prevent="sortBy('rigzhung')" role="button" href="#">Rig
                                     @include('includes._sort-icon',['field'=>'rigzhung'])</a>
                               </th>
                               <th class="header">
