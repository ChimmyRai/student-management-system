<div class="card">
    <div class="card-header">Result Upload (Class 11 and 12 Commerce)</div>
    <div class="card-body">
             ...
             Download table:<br/>
               ...
               <table class="table table-bordered">
                            ...
                            <!--  <th class="nonToogleDisplay header">
                             ...
                             <th class="header">
                                 <a wire:click.prevent="sortBy('commerce')" role="button" href="#">Com
                                   @include('includes._sort-icon',['field'=>'commerce'])</a>
                             </th>

                               <th class="header">
                                   <a wire:click.prevent="sortBy('accountancy')" role="button" href="#">Acc
                                     @include('includes._sort-icon',['field'=>'accountancy'])</a>
                               </th>
                               <th class="header">
