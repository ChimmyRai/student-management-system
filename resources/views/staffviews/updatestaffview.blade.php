...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">{{$staffdetail->Name}} Details</div>
                <div class="card-body">
                  {!!Form::model($staffdetail,['files' =>'true','method'=>'PATCH', 'action'=>['StaffDetailsController@update',$staffdetail->id]]) !!}
                  ...
                  <div class="form-group">
                    ...
                    <img id="blah" width="200px" src="/public/images/staff/{{$staffdetail->img_location}}?new Date().getTime()" />
