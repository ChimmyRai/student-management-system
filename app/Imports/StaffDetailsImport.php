...
class StaffDetailsImport implements ToModel, WithHeadingRow, SkipsOnError, WithValidation, SkipsOnFailure, WithBatchInserts, WithChunkReading
{
  use Importable,SkipsErrors,SkipsFailures;
   ...
   public function rules(): array
    {
        return [
            '*.cid' =>['required','numeric','unique:staffdetails,cid'],
            '*.name' =>['required'],
            '*.dob' =>['required'],
            '*.gender' =>['required'],
            '*.religion' =>['required'],
