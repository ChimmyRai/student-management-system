...
class MiddleResultImport implements ToModel,  WithHeadingRow, SkipsOnError, WithValidation, SkipsOnFailure, WithBatchInserts, WithChunkReading
{
    ...
    */
    ...
    public function rules(): array
     {
         return [
            '*.student_code'=>['required','string','unique:resultmiddles,student_code','regex:/^[0-9]+(\.[0-9]+)+$/'],
            ...
            '*.science' =>['required','min:0','max:100'],
            '*.hcg' =>['required','min:0','max:100'],
            '*.evs' =>['min:0','max:100'],
