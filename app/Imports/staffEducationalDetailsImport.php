...
class staffEducationalDetailsImport implements ToModel, WithHeadingRow, SkipsOnError, WithValidation, SkipsOnFailure, WithBatchInserts, WithChunkReading
{
...
public function rules(): array
         {
             return [
                 '*.cid' =>['required','numeric','unique:educationaldetailofstaffs,cid'],
                 '*.academic_qualification' =>['required','string'],
                 '*.subject_specialization' =>['required','string'],
                 '*.trc_subject' =>['required','string'],
             ];
         }
